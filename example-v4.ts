...
// In this example, we'll swap CryptoPunk #69 for 420 WETH
  ...
  const CHAIN_ID = 1001; // Baobab testnet
...
// Set up the provider and signer for the maker (owner of the punk)
  const provider = new ethers.providers.StaticJsonRpcProvider('https://api.baobab.klaytn.net:8651'); // Replace with your own Infura API key
...
// [Part 1: Maker (owner of the Punk) creates trade]
  let nftSwapSdk = new NftSwapV4(provider, signerForMaker,CHAIN_ID,{ zeroExExchangeProxyContractAddress: '0xef01352610ffe924821afaa27a29ee048caa09b7'});
...
// [Part 2: Taker (wants to buy the punk) fills trade]
  nftSwapSdk = new NftSwapV4(provider, signerForTaker, CHAIN_ID, { zeroExExchangeProxyContractAddress: '0xef01352610ffe924821afaa27a29ee048caa09b7' });
